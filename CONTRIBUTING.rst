...
Thank you for your help improving **sampling-handler**!

**sampling-handler** uses `nox <https://nox.thea.codes/en/stable/>`__ to automate several development-related tasks.
...
First off, you'll need your own copy of **sampling-handler** codebase. You can clone it for local development like so:
...
.. code-block:: console
   ...
   git clone https://github.com/<YOUR USERNAME>/sampling-handler
   cd sampling-handler
...
This will install the **sampling-handler** library, together with two additional tools:
